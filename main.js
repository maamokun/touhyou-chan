                    ...
                    if (sql[0]) {
                        ...
                        if (publicPoll[0] === 1) {
                            ...
                            const embed = new MessageEmbed()
                                ...
                                .addField(`アイテム`, pollItem, true)
                                .addField(`票数 (合計票数: ${graphTotalVotes})`, graph, true)
                            try {
                            ...
                            await interaction.followUp({
                                    content: `"票変更: "${originalChoice}" :arrow_right: "${choice}"`,
                                    fetchReply: true,
                                    ephemeral: true
                                })
                        ...
                        if (publicPoll[0] === 1) {
                            ...
                            const embed = new MessageEmbed()
                                ...
                                .addField(`アイテム`, pollItem, true)
                                .addField(`結果 (合計票数: ${graphTotalVotes})`, graph, true)
                            try {
                                await interaction.update({
                                    embeds: [embed],
                                })
                ...
                try {
                    ...
                    if (interaction.member.roles.cache.some(role => role.name === roleName) || interaction.member.permissions.has(Permissions.FLAGS['MANAGE_GUILD'])) {
                        ...
                        const embed = new MessageEmbed()
                            ...
                            .addField(`アイテム`, pollItem, true)
                            .addField(`結果 (合計票数: ${graphTotalVotes})`, graph, true)
                            .setFooter(`締め切り時刻 ${interaction.createdAt} 締め切ったユーザー: ${interaction.member.displayName}`)
                        try {
                            await interaction.update({
                                    embeds: [embed],
                                    components: [],
                            ...
                            await interaction.reply({
                                content: 'システムエラーが発生しました！繰り返し発生してましたら `/help` のサポートサーバーにお問い合わせください。',
                                ephemeral: true,
                            })
                        }
                        try {
                        ...
                        interaction.reply({
                                content: "\`MANAGE_GUILD\` 権限または \"投票マネージャー\" ロールがないため、投票を締め切る権限がありません。",
                                ephemeral: true
                            })
